            ...
            <div className="outer-footer">
                ...
                <div className="Footer">
                    <div className="Footer-top">
                        <div className="div1">
                            <h2>SafeZen</h2>
                            <p>the world's first zero premium and pay-as-you-go insurance products based on risk-based coverage pools</p>
                        </div>
                        {/* <div className="div2">
