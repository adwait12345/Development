...
// Main Function Start
export default function Chart_Claims() {
  return (
    <>
        ...
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
          <TableHead>
            <TableRow>
              ...
              <TableCell className="Tablecell" align="right">
               Policy Period&nbsp; <BsInfoCircle color="#fff" />
              </TableCell>
              <TableCell className="Tablecell" align="right">
               Maj / Min &nbsp; <BsInfoCircle color="#fff" />
              </TableCell>
              <TableCell className="Tablecell" align="right">
                Voters &nbsp; <BsInfoCircle color="#fff" />
              </TableCell>
              <TableCell className="Tablecell" align="right">
                Date Submitted &nbsp; <BsInfoCircle color="#fff" />
              </TableCell>
              <TableCell className="Tablecell" align="right">
                Verdict &nbsp; <BsInfoCircle color="#fff" />
              </TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
