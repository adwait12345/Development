...
import { MdOutlineHealthAndSafety, MdOutlineArrowForwardIos, MdArrowUpward, MdArrowDownward, MdOutlineKeyboardArrowRight, MdKeyboardArrowLeft } from "react-icons/md";
          ...
          {Insurance.map((Insurance) => {
              return (
                  <Link to='/cover/BuyPolicy'>
                      <div className="card_insu" onClick={function (event) { dispatch(setActivatedInsurance(Insurance._state)) }}>
                          <div className="top_card_insu">
                              <div className="top_Insu_start">
                                  <button><MdOutlineHealthAndSafety color='#fff' size={30} /></button>
                          ...
                          <div className="mid_card_insu">
                              ...
                              <div className="mid_card_insu_end">

                              </div>

                          </div>
                          <div className="bot_card-insu">
                              <p><MdArrowUpward color='#55C2FA' />&nbsp; {Insurance._growth_in_SZT} <span>	&nbsp; SZT</span> </p>
                              <p><MdArrowDownward color='#CD6D5E' /> &nbsp; {Insurance._loss_in_SZT} <span>	&nbsp; SZT</span></p>
                              <p><BsStar color='#FBA905' />&nbsp; {Insurance._premium} <span>	&nbsp; VIP</span></p>
                          </div>
                      </div></Link>)
          })}
