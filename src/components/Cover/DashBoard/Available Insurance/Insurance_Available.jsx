...
import { MdOutlineHealthAndSafety, MdOutlineArrowForwardIos, MdArrowUpward, MdArrowDownward, MdOutlineKeyboardArrowRight } from "react-icons/md";
...
export default function Insurance_Available() {
  ...
  return (
    ...
    <div className="Insurance_Available">
       ...
       <p>see all <MdOutlineKeyboardArrowRight/></p> 
       </Link>
