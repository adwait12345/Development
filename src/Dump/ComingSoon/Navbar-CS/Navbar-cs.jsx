      ...
      <div className="Navbar">
        <div className="innernavbar">
          ...
          <div className="mid-menu">
              ...
              <a href="https://drive.google.com/file/d/1QFRwtGgwh38ZGAI9ARnlVhsRushCRXN7/view"  target="_blank">
 <li>
